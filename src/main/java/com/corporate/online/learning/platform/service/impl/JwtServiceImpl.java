...
public class JwtServiceImpl implements JwtService {
    ...
    public String generateToken(Map<String, Object> extraClaims, UserDetails userDetails) {
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + applicationConfig.getAccountExpirationTime()))
    ...
    private Key getSigningKey(){
        byte[] keyToBytes = Decoders.BASE64.decode(applicationConfig.getSecurityKey());
